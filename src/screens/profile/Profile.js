...
class Profile extends Component {
    ...
    getUserInfo = () => {
        let that = this;
        let url = 'https://api.instagram.com/v1/users/self/?access_token=8661035776.d0fcd39.39f63ab2f88d4f9c92b0862729ee2784';
        return fetch(url, {
            method: 'GET',
        }).then((response) => {
    ...
    getMediaData = () => {
        let that = this;
        let url = 'https://api.instagram.com/v1/users/self/media/recent?access_token=8661035776.d0fcd39.39f63ab2f88d4f9c92b0862729ee2784';
        return fetch(url,{
            method: 'GET',
        }).then((response) => {
            return response.json();
        ...
        return(
            <div>
                <Header
                  screen="Profile"
                  showProfilePic="true"
                  pictureUrl={this.state.profile_picture}
